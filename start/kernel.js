...
const namedMiddleware = {
  auth: 'Adonis/Middleware/Auth',
  caching: 'App/Middleware/ContentCaching',
  throttle: 'Adonis/Middleware/ThrottleRequests',
  permission: 'App/Middleware/Permission',
  permissionSome: 'App/Middleware/PermissionSome',
  modulesFilesTeamsPermission: 'App/Middleware/ModulesFilesTeamsPermission'
}
